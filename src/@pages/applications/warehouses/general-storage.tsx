    ...
    <Layout>
      ...
      <div className="bg-bg-light border-b border-border">
        <div className="container py-4">
          <nav className="flex items-center gap-2 text-sm">
            ...
            <AppLink href="/applications/warehouses" className="text-text-secondary hover:text-primary transition-colors">
              Склады
            </AppLink>
            <span className="text-text-light">/</span>
      ...
      <section className="relative py-16 md:py-24 overflow-hidden">
        ...
        <div className="container relative z-10">
          <AppLink href="/applications/warehouses" className="inline-flex items-center gap-2 text-white/80 hover:text-white mb-6 transition-colors">
          ...
          <p className="text-xl md:text-2xl text-white/80 max-w-3xl">
            Комплексное решение для защиты товаров, продления сроков хранения, борьбы с вредителями и создания здоровой рабочей среды для персонала.
          </p>
        </div>
      </section>
      ...
      <article className="py-12 md:py-16">
        <div className="container max-w-4xl">
          ...
          <ArticleSection>
            <Paragraph>
              Современная складская логистика требует комплексного подхода к поддержанию качества хранимых товаров. Озонирование воздуха — универсальная технология, решающая задачи дезинфекции, дезодорации, борьбы с вредителями и профилактики порчи продукции одновременно.
            </Paragraph>
            <Paragraph>
              Для логистических операторов и владельцев складских комплексов озонирование становится стандартом качества, позволяющим снизить потери, продлить сроки хранения товаров и обеспечить соответствие санитарным требованиям без постоянного применения химических средств.
            </Paragraph>
          </ArticleSection>

          <HighlightBox variant="info">
            <strong>Для менеджеров по логистике:</strong> Озонирование — это обработка большого объёма воздуха без необходимости выгрузки товаров. Газ проникает во все зоны склада, включая труднодоступные места между паллетами и на верхних ярусах стеллажей.
          </HighlightBox>

          <ArticleSection title="Типы складов и рекомендованные решения">
            <Paragraph>
              Подход к озонированию различается в зависимости от типа складского помещения, хранимой продукции и интенсивности товарооборота.
            </Paragraph>
          ...
          <ArticleSection title="Расчёт покрытия для больших пространств">
            <Paragraph>
              Для эффективной обработки складов площадью от 1000 м² необходимо учитывать не только объём помещения, но и высоту потолков, наличие стеллажей, интенсивность воздухообмена и тип хранимых товаров.
            </Paragraph>
            ...
            <HighlightBox variant="success">
              <strong>Пример расчёта:</strong> Склад 3000 м² × 8 м высота = 24000 м³. Базовая производительность: 24000÷25 = 960 г/ч. С учётом стеллажей (×1.3): 1248 г/ч. Рекомендуется установка 4-5 озонаторов по 250-300 г/ч или интеграция в систему вентиляции.
            </HighlightBox>
          </ArticleSection>

          <ArticleSection title="Интеграция с системой вентиляции (HVAC)">
            <Paragraph>
              Для крупных логистических комплексов оптимальным решением является интеграция озонаторного оборудования в существующую систему вентиляции и кондиционирования.
            </Paragraph>
          ...
          <ArticleSection title="Частота обработки и оптимальный график">
            <Paragraph>
              Регулярность озонирования зависит от типа склада, интенсивности товарооборота и требований к качеству хранения. Для большинства складов достаточно 2-4 обработок в неделю в нерабочее время.
            </Paragraph>
            ...
            <HighlightBox variant="info">
              <strong>Оптимальный график:</strong> Рекомендуется проводить озонирование в ночные часы (22:00 — 06:00). При правильно подобранном времени обработки озон полностью выветрится к началу рабочего дня без необходимости специального проветривания.
            </HighlightBox>
          </ArticleSection>

          <ArticleSection title="Профилактика появления вредителей">
            <Paragraph>
              Озон эффективен против широкого спектра складских вредителей: насекомых, грызунов, клещей. Регулярная обработка создаёт неблагоприятную среду для их обитания и размножения.
            </Paragraph>
            ...
            <Paragraph>
              При обнаружении вредителей озонирование используется как часть комплекса мер по дезинсекции. Озон не заменяет профессиональную обработку при сильном заражении, но эффективен для профилактики и поддерживающих обработок.
            </Paragraph>
          </ArticleSection>

          <ArticleSection title="Качество воздуха для персонала">
            <Paragraph>
              Озонирование улучшает условия труда складских работников: устраняет затхлые запахи, снижает концентрацию пыли и аллергенов, уничтожает болезнетворные микроорганизмы в воздухе.
            </Paragraph>
            ...
            <HighlightBox variant="warning">
              <strong>Требования безопасности:</strong> ПДК озона в рабочей зоне — 0,1 мг/м³. Обработка проводится в отсутствие людей. Персоналу, осуществляющему обслуживание во время озонирования, необходимо использовать респиратор или противогаз с угольным фильтром.
            </HighlightBox>
          </ArticleSection>

          <ArticleSection title="Соответствие требованиям хранения">
            <Paragraph>
              Озонирование помогает соответствовать санитарным требованиям к складским помещениям различных классов. При этом озон не оставляет химических остатков на товарах и совместим с большинством материалов.
            </Paragraph>
          ...
          <ArticleSection title="Экономика внедрения">
            <Paragraph>
              Инвестиции в озонирование окупаются за счёт снижения потерь, экономии на химической обработке и улучшения показателей здоровья персонала.
            </Paragraph>
            ...
            <Paragraph>
              * Включая амортизацию оборудования, электроэнергию и техническое обслуживание. Чистая экономия: около 330 000 ₽/год. Срок окупаемости оборудования: 8-14 месяцев.
            </Paragraph>
          </ArticleSection>
      ...
      <section className="cta">
        <div className="container">
          ...
          <p className="cta__text">Получите бесплатный аудит и расчёт оборудования для вашего логистического комплекса</p>
