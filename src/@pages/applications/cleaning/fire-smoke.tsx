    ...
    <Layout>
      ...
      <div className="bg-bg-light border-b border-border">
        <div className="container py-4">
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-text-light">/</span>
            <span className="text-text-primary font-medium">Последствия пожара</span>
          </nav>
        </div>
      </div>
      ...
      <section className="relative py-16 md:py-24 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt="Устранение запаха гари после пожара"
            fill
        ...
        <div className="container relative z-10">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
            Удаление запаха гари после пожара
          </h1>
          <p className="text-xl md:text-2xl text-white/80 max-w-3xl">
            Полное устранение последствий задымления без капитального ремонта. Озон проникает в стены, перекрытия и мебель, разрушая частицы сажи на молекулярном уровне.
          </p>
        </div>
      </section>
        ...
        <div className="container">
          <StatGrid columns={4}>
            ...
            <StatCard
              value="2-3"
              label="Цикла"
              description="Для сильного задымления"
              variant="primary"
            />
            <StatCard
              value="100%"
              label="Устранение"
              description="Запаха гари без ремонта"
              variant="accent"
            />
          </StatGrid>
        </div>
      ...
      <article className="py-12 md:py-16">
        <div className="container max-w-4xl">
          ...
          <ArticleSection>
            <Paragraph>
              Запах гари после пожара — один из самых стойких и сложных для устранения. Продукты горения проникают глубоко в строительные материалы: штукатурку, бетон, кирпич, дерево. Мельчайшие частицы сажи впитываются в текстиль, мягкую мебель, ковры, обои. Традиционная уборка и проветривание не помогают — запах возвращается снова и снова.
            </Paragraph>
            <Paragraph>
              Многие владельцы помещений после пожара вынуждены делать полный капитальный ремонт с заменой отделки. Однако озонирование позволяет решить проблему быстрее и дешевле — без демонтажа стен и замены мебели.
            </Paragraph>
          </ArticleSection>

          <HighlightBox variant="info">
            <strong>Почему запах гари такой стойкий:</strong> При горении органических материалов образуются полициклические ароматические углеводороды (ПАУ), сажа, смолы. Эти вещества имеют микроскопический размер частиц (0,1-1 мкм) и глубоко проникают в поры строительных материалов. Обычная уборка удаляет только поверхностный слой.
          </HighlightBox>

          <ArticleSection title="Как озон устраняет запах гари">
            <Paragraph>
              Озон — газ, который проникает везде, куда проникли частицы дыма и сажи. Он окисляет органические соединения на молекулярном уровне, разрушая химические связи в молекулах продуктов горения. В результате образуются безопасные соединения — вода и углекислый газ.
            </Paragraph>
            <BulletList items={[
            ...
            <ProcessList steps={[
              {
                ...
                description: 'Удалить видимую копоть и сажу со всех поверхностей. Протереть стены, потолки, полы. Пропылесосить мягкую мебель и ковры. Вынести сильно повреждённые предметы.'
              },
              {
                title: 'Герметизация помещения',
                description: 'Закрыть все окна и двери. Заклеить вентиляционные отверстия. Загерметизировать щели. Это необходимо для поддержания высокой концентрации озона.'
              },
              {
                title: 'Первый цикл озонирования',
                description: 'Установить озонатор, покинуть помещение. Обработка при концентрации 40-80 мг/м³ в течение 8-24 часов. Озон должен полностью заполнить объём помещения.'
              },
              {
                title: 'Проветривание и оценка',
                description: 'Проветрить помещение 2-4 часа до полного исчезновения запаха озона. Оценить результат. При необходимости провести дополнительную влажную уборку.'
              },
              {
                title: 'Повторные циклы (при необходимости)',
                description: 'При сильном задымлении требуется 2-3 цикла обработки с перерывами на проветривание. Каждый цикл дополнительно снижает концентрацию запаха.'
              },
            ]} />
          </ArticleSection>
          ...
          <ArticleSection title="Режимы обработки в зависимости от степени повреждения">
            ...
            <HighlightBox variant="warning">
              <strong>Важно:</strong> Озон не удаляет сажу физически — он устраняет только запах. Перед озонированием обязательна механическая уборка. Также озон не восстанавливает повреждённые материалы — обгоревшие поверхности требуют ремонта.
            </HighlightBox>
          </ArticleSection>
          ...
          <ArticleSection title="Сравнение методов устранения запаха гари">
            <ComparisonTable
              ...
              rows={[
                ...
                { parameter: 'Необходимость выселения', value1: 'На время обработки', value2: 'На весь период ремонта' },
              ]}
            />
          </ArticleSection>
          ...
          <ArticleSection title="Когда озонирование не поможет">
            ...
            <HighlightBox variant="success">
              <strong>Рекомендация:</strong> Для достижения максимального эффекта комбинируйте озонирование с профессиональной уборкой. Сначала — механическое удаление копоти, затем — озонирование для устранения въевшегося запаха.
            </HighlightBox>
          </ArticleSection>
      ...
      <section className="cta">
        <div className="container">
          <h2 className="cta__title">Восстановить помещение после пожара?</h2>
          <p className="cta__text">Получите консультацию по устранению запаха гари без капитального ремонта</p>
