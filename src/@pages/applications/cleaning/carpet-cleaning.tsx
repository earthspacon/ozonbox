      ...
      <section className="relative overflow-hidden py-16 md:py-24">
        ...
        <div className="relative z-10 container">
          ...
          <p className="max-w-3xl text-xl text-white/80 md:text-2xl">
            Глубокая дезодорация и дезинфекция текстиля. Устранение запаха затхлости, уничтожение пылевых клещей,
            профилактика плесени. Идеальное дополнение к химчистке.
          </p>
        </div>
      </section>
