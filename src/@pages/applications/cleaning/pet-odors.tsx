    ...
    <Layout>
      ...
      <section className="relative py-16 md:py-24 overflow-hidden">
        ...
        <div className="container relative z-10">
          ...
          <p className="text-xl md:text-2xl text-white/80 max-w-3xl">
            Полное устранение запаха кошачьей и собачьей мочи, меток, шерсти. Разрушение кристаллов мочевой кислоты на молекулярном уровне — запах не вернётся.
          </p>
        </div>
      </section>
        ...
        <div className="container">
          <StatGrid columns={4}>
            <StatCard
              value="100%"
              label="Устранение"
              description="Кристаллов мочевой кислоты"
              variant="primary"
            />
            <StatCard
              value="4-8 ч"
            ...
            <StatCard
              value="2-3"
              label="Цикла"
              description="При сильном заражении"
              variant="primary"
            />
            <StatCard
              value="99,9%"
              label="Бактерий"
              description="Уничтожается дополнительно"
              variant="accent"
            />
          </StatGrid>
        </div>
      ...
      <article className="py-12 md:py-16">
        <div className="container max-w-4xl">
          ...
          <ArticleSection>
            <Paragraph>
              Запах домашних животных, особенно кошачьей мочи — одна из самых частых причин обращения в клининговые компании. Этот запах практически невозможно устранить обычными средствами. Освежители воздуха лишь маскируют проблему, а запах возвращается снова и снова, особенно во влажную погоду.
            </Paragraph>
            <Paragraph>
              Причина стойкости запаха — мочевая кислота. В отличие от других компонентов мочи (мочевины и урохрома), она не растворяется в воде и кристаллизуется в волокнах ткани. При повышении влажности кристаллы активируются и снова выделяют резкий аммиачный запах.
            </Paragraph>
          </ArticleSection>

          <HighlightBox variant="info">
            <strong>Почему обычные средства не работают:</strong> Большинство чистящих средств удаляют водорастворимые компоненты мочи, создавая иллюзию чистоты. Но кристаллы мочевой кислоты остаются в волокнах ткани и активируются при повышении влажности. Озон разрушает эти кристаллы химически, что делает результат постоянным.
          </HighlightBox>

          <ArticleSection title="Как озон устраняет запах животных">
            <Paragraph>
              Озон — сильнейший окислитель, который разрушает молекулярную структуру мочевой кислоты. Будучи газом, он проникает везде, куда могла попасть моча: в обивку мебели, ковры, матрасы, плинтусы, щели в полу.
            </Paragraph>
            <BulletList items={[
            ...
            <ProcessList steps={[
              {
                ...
                description: 'Определить все места, где животные оставляли метки. Использовать УФ-фонарик — моча светится в ультрафиолете. Отметить все обнаруженные пятна.'
              },
              {
                title: 'Предварительная очистка',
                description: 'Обработать видимые пятна ферментным очистителем. Он расщепляет органические компоненты мочи. Дать полностью высохнуть перед озонированием.'
              },
              {
                title: 'Подготовка помещения',
                description: 'Убрать домашних животных и комнатные растения. Закрыть окна, двери, вентиляцию. Поднять шторы и занавески для лучшего доступа озона.'
              },
              {
                title: 'Озонирование',
                description: 'Установить озонатор в центре помещения. Включить на 4-8 часов при концентрации 20-60 мг/м³. Для равномерного распределения использовать вентилятор.'
              },
              {
                title: 'Оценка и повторная обработка',
                description: 'Проветрить помещение 1-2 часа. Оценить результат. При сильном заражении повторить обработку через 24 часа. Обычно требуется 2-3 цикла.'
              },
            ]} />
          </ArticleSection>
          ...
          <ArticleSection title="Сравнение методов устранения запаха">
            <ComparisonTable
              ...
              rows={[
                ...
                { parameter: 'Глубина проникновения', value1: 'На всю толщину материала', value2: 'Только поверхность' },
                { parameter: 'Труднодоступные места', value1: 'Да (газ проникает везде)', value2: 'Нет (только ручная обработка)' },
                { parameter: 'Длительность эффекта', value1: 'Постоянно', value2: 'Может потребоваться повторение' },
                { parameter: 'Время обработки', value1: '4-8 часов (автоматически)', value2: '1-24 часа (ручной труд)' },
          ...
          <ArticleSection title="Локальная обработка мебели">
            ...
            <HighlightBox variant="success">
              <strong>Совет:</strong> Для усиления эффекта при обработке мягкой мебели слегка увлажните поверхность из пульверизатора. Влага активирует кристаллы мочевой кислоты, делая их более доступными для окисления озоном.
            </HighlightBox>
          </ArticleSection>

          <ArticleSection title="Профилактика повторного заражения">
            <Paragraph>
              После озонирования важно предотвратить повторное появление меток:
            </Paragraph>
            <BulletList items={[
            ...
            <HighlightBox variant="warning">
              <strong>Техника безопасности:</strong> Озонирование проводится в полном отсутствие животных! Озон токсичен для домашних питомцев так же, как и для людей. Верните животных в помещение только после полного проветривания (1-2 часа).
            </HighlightBox>
          </ArticleSection>
