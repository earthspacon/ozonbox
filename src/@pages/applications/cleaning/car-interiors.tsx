    ...
    <Layout>
      ...
      <section className="relative overflow-hidden py-16 md:py-24">
        ...
        <div className="relative z-10 container">
          ...
          <h1 className="mb-6 text-4xl font-bold text-white md:text-5xl lg:text-6xl">Озонирование салона автомобиля</h1>
          <p className="max-w-3xl text-xl text-white/80 md:text-2xl">
            Глубокая дезинфекция и дезодорация за 30-60 минут. Обработка сидений, ковриков, потолка и системы
            кондиционирования. Устранение запаха табака, еды, животных.
          </p>
        </div>
      </section>
      ...
      <section className="bg-bg-light py-12">
        <div className="container">
          <StatGrid columns={4}>
            <StatCard value="30-60" label="Минут" description="Стандартная обработка салона" variant="primary" />
            <StatCard value="99,9%" label="Бактерий" description="Уничтожается в системе вентиляции" variant="accent" />
            <StatCard value="15" label="Минут" description="Проветривание после обработки" variant="primary" />
            <StatCard value="0" label="Следов" description="Химических остатков в салоне" variant="accent" />
          </StatGrid>
        </div>
      </section>
      ...
      <article className="py-12 md:py-16">
        <div className="container max-w-4xl">
          <ArticleSection>
            <Paragraph>
              Салон автомобиля — замкнутое пространство, в котором быстро накапливаются запахи: табачный дым, пот, еда,
              напитки, домашние животные. Все эти запахи впитываются в текстильные элементы салона: сиденья, ковры,
              потолок, а также в систему вентиляции и кондиционирования.
            </Paragraph>
            <Paragraph>
              Химчистка салона удаляет грязь и пятна, но не всегда справляется с въевшимися запахами. Ароматизаторы и
              освежители лишь маскируют проблему. Озонирование — единственный метод, который полностью уничтожает
              молекулы запаха, включая те, что находятся в воздуховодах кондиционера.
            </Paragraph>
          </ArticleSection>

          <HighlightBox variant="info">
            <strong>Важно:</strong> Неприятный запах при включении кондиционера — признак того, что в системе вентиляции
            развились бактерии и грибки. Обычная химчистка салона их не уничтожает. Озон же проникает во все воздуховоды
            и устраняет проблему в источнике.
          </HighlightBox>
              ...
              steps={[
                {
                  ...
                  description:
                    'Провести стандартную уборку: пропылесосить, протереть пластиковые поверхности. Удалить мусор и личные вещи. Достать коврики для отдельной обработки.',
                },
                {
                  title: 'Размещение озонатора',
                  description:
                    'Установить озонатор в салоне на переднем сиденье или на полу. Закрыть все окна и двери. Оставить небольшую щель для шланга питания, если озонатор внешний.',
                },
                {
                  title: 'Обработка системы вентиляции',
                  description:
                    'Включить зажигание, установить режим рециркуляции воздуха, включить вентилятор на максимум. Это обеспечит циркуляцию озона через систему кондиционирования.',
                },
                {
                  title: 'Озонирование',
                  description:
                    'Запустить озонатор на 20-40 минут при концентрации 20-40 мг/м³. При сильных запахах — до 60 минут. Покинуть автомобиль на время обработки.',
                },
                {
                  title: 'Проветривание',
                  description:
                    'Открыть все двери и окна. Проветривать 15-30 минут. Включить кондиционер на режим притока свежего воздуха. Автомобиль готов к использованию.',
                },
              ]}
            />
          </ArticleSection>
          ...
          <ArticleSection title="Озонирование как услуга автомоек и детейлинга">
            <Paragraph>
              Для автомоек и детейлинг-центров озонирование — высокомаржинальная дополнительная услуга. Оборудование
              компактно, не требует расходных материалов, окупается за 1-2 месяца при активном предложении клиентам.
            </Paragraph>
            ...
            <HighlightBox variant="success">
              <strong>Маркетинговый совет:</strong> Предлагайте озонирование как обязательную часть предпродажной
              подготовки автомобиля. Покупатели б/у авто особенно чувствительны к посторонним запахам — это частая
              причина отказа от покупки.
            </HighlightBox>
          </ArticleSection>

          <ArticleSection title="Озонирование для каршеринга и такси">
            <Paragraph>Автопарки такси и каршеринга — идеальные клиенты для регулярного озонирования:</Paragraph>
            <BulletList
              items={[
          ...
          <ArticleSection title="Сравнение с альтернативными методами">
            <ComparisonTable
              ...
              rows={[
                {
                  parameter: 'Принцип действия',
                  value1: 'Разрушение молекул запаха',
                  value2: 'Маскировка другим запахом',
                },
                { parameter: 'Система вентиляции', value1: 'Полная обработка', value2: 'Не обрабатывается' },
                {
                  parameter: 'Длительность эффекта',
                  value1: 'Постоянно (до нового загрязнения)',
                  value2: 'Временно (часы/дни)',
                },
          ...
          <ArticleSection title="Особенности работы с разными типами салонов">
            ...
            <HighlightBox variant="warning">
              <strong>Важно:</strong> После озонирования кожаного салона рекомендуется обработать кожу кондиционером.
              Озон может слегка подсушивать натуральную кожу, хотя при правильных концентрациях это не критично.
            </HighlightBox>
          </ArticleSection>
        </div>
      </article>
