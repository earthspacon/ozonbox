    ...
    <Layout>
      ...
      <div className="bg-bg-light border-b border-border">
        <div className="container py-4">
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-text-light">/</span>
            <span className="text-text-primary font-medium">Коммерческий автотранспорт</span>
          </nav>
        </div>
      </div>
      ...
      <section className="relative py-16 md:py-24 overflow-hidden">
        ...
        <div className="container relative z-10">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
            Озонирование коммерческого автотранспорта
          </h1>
          <p className="text-xl md:text-2xl text-white/80 max-w-3xl">
            Дезинфекция грузовых автомобилей, фургонов и рефрижераторов. Санитарная безопасность пищевых перевозок, устранение запахов, соответствие ХАССП.
          </p>
        </div>
      </section>
        ...
        <div className="container">
          <StatGrid columns={4}>
            <StatCard
              value="20-40"
              label="минут"
              description="Обработка кузова грузовика"
              variant="primary"
            />
            <StatCard
              value="ХАССП"
              label="Соответствие"
              description="Требованиям пищевых перевозок"
              variant="accent"
            />
            <StatCard
              value="12/24В"
              label="Питание"
              description="Работа от бортовой сети"
              variant="primary"
            />
            <StatCard
              value="10-15"
              label="машин в смену"
              description="Обрабатывает 1 оператор"
              variant="accent"
            />
          </StatGrid>
        </div>
      ...
      <article className="py-12 md:py-16">
        <div className="container max-w-4xl">
          ...
          <ArticleSection>
            <Paragraph>
              Коммерческий автотранспорт — от небольших фургонов до магистральных тягачей — требует регулярной санитарной обработки. Особенно это критично для перевозчиков продуктов питания: молочной продукции, мяса, овощей и фруктов. Санитарные нормы и требования ХАССП обязывают поддерживать чистоту грузового отсека.
            </Paragraph>
            <Paragraph>
              Озонирование — эффективный и экономичный метод санитарной обработки автопарка. Один мобильный озонатор обрабатывает 10-15 грузовиков в смену, работает от бортовой сети, не требует расходных материалов. Для логистических компаний это значительная экономия по сравнению с химической обработкой.
            </Paragraph>
          </ArticleSection>

          <HighlightBox variant="info">
            <strong>Для менеджеров автопарков:</strong> Интегрируйте озонирование в график технического обслуживания. Пока водитель оформляет документы или отдыхает между рейсами — грузовик обрабатывается. Это не создаёт дополнительных простоев.
          </HighlightBox>

          <ArticleSection title="Типы коммерческого транспорта">
            <Paragraph>
              Озонирование применяется для всех типов грузового автотранспорта:
            </Paragraph>
            <BulletList items={[
          ...
          <ArticleSection title="Проблемы санитарии в грузоперевозках">
            <Paragraph>
              Грузовой отсек автомобиля подвергается загрязнению из различных источников:
            </Paragraph>
            <BulletList items={[
            ...
            <Paragraph>
              Традиционная мойка и протирка не решают проблему полностью. Вода не убивает бактерии, запахи возвращаются, плесень прорастает вновь. Нужна именно дезинфекция.
            </Paragraph>
          </ArticleSection>
            ...
            <ProcessList steps={[
              {
                ...
                description: 'Выгрузить груз, удалить мусор и остатки упаковки. При сильном загрязнении — предварительная влажная уборка.'
              },
              {
                title: 'Размещение озонатора',
                description: 'Установить озонатор внутри кузова на максимальной высоте. Подключить к бортовой сети (12В/24В) или внешнему источнику.'
              },
              {
                title: 'Герметизация',
              ...
              {
                title: 'Озонирование',
                description: 'Включить озонатор, запустить таймер. Время обработки 20-40 минут в зависимости от объёма и загрязнения.'
              },
              {
                title: 'Проветривание',
                description: 'Открыть двери, включить вентиляцию рефрижератора (если есть). Проветривать 15-20 минут.'
              },
            ]} />

            <HighlightBox variant="success">
              После проветривания кузов готов к погрузке. Озон распался до кислорода, химических остатков нет, груз не подвергается риску загрязнения.
            </HighlightBox>
          </ArticleSection>
          ...
          <ArticleSection title="Особенности обработки рефрижераторов">
            <Paragraph>
              Рефрижераторы и изотермические фургоны требуют особого внимания — именно в них перевозятся продукты питания с жёсткими санитарными требованиями.
            </Paragraph>
            <BulletList items={[
            ...
            <HighlightBox variant="info">
              <strong>Для ХАССП:</strong> Фиксируйте каждую обработку в журнале с указанием даты, номера машины, параметров (время, концентрация). Это документальное подтверждение соблюдения санитарных требований при аудитах.
            </HighlightBox>
          </ArticleSection>

          <ArticleSection title="Устранение запахов">
            <Paragraph>
              Одна из главных проблем грузоперевозок — запахи от предыдущих грузов:
            </Paragraph>
            <BulletList items={[
            ...
            <Paragraph>
              Озон окисляет молекулы запаха, превращая их в нейтральные соединения. Это не маскировка, а полное устранение. После обработки кузов пахнет свежестью — «как после грозы».
            </Paragraph>
          ...
          <ArticleSection title="Экономика для автопарка">
            <ComparisonTable
              ...
              rows={[
                ...
                { parameter: 'Стоимость обработки 1 машины', value1: '30-50 ₽ (электричество)', value2: '500-1500 ₽ (услуга/материалы)' },
                { parameter: 'Персонал', value1: '1 оператор', value2: '3-5 мойщиков' },
                { parameter: 'Время на машину', value1: '30-40 мин (без участия)', value2: '60-90 мин (ручная работа)' },
            ...
            <Paragraph>
              При обработке 50 машин 2 раза в неделю экономия составляет 100-200 тысяч рублей в месяц. Окупаемость озонаторов — 2-4 месяца. Дополнительный эффект — снижение жалоб клиентов на запахи и загрязнения.
            </Paragraph>
          </ArticleSection>

          <ArticleSection title="Соответствие санитарным нормам">
            <Paragraph>
              Озонирование грузового транспорта соответствует требованиям:
            </Paragraph>
            <BulletList items={[
            ...
            <HighlightBox variant="warning">
              <strong>Документирование:</strong> Храните журналы обработки минимум 1 год. При аудитах ХАССП, проверках Роспотребнадзора или претензиях клиентов — это ваша защита.
            </HighlightBox>
          </ArticleSection>

          <ArticleSection title="Оборудование для автопарков">
            <Paragraph>
              Для обработки коммерческого транспорта применяются:
            </Paragraph>
            <BulletList items={[
              ...
              'Модификации 12В/24В — для работы от бортовой сети без внешнего питания',
          ...
          <ArticleSection title="ROI для операторов автопарков">
            <Paragraph>
              Расчёт возврата инвестиций для автопарка из 30 грузовиков:
            </Paragraph>
            <BulletList items={[
            ...
            <HighlightBox variant="success">
              <strong>Дополнительная выгода:</strong> Репутационный эффект. Чистые, без запаха грузовики — это уверенность клиентов в качестве перевозки. Крупные торговые сети и производители выбирают перевозчиков с подтверждённой санитарной обработкой.
            </HighlightBox>
          </ArticleSection>
      ...
      <section className="cta">
        <div className="container">
          <h2 className="cta__title">Оптимизировать санитарную обработку автопарка?</h2>
          <p className="cta__text">Получите бесплатную консультацию и расчёт оборудования для вашего автопарка</p>
