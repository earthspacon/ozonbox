      ...
      <section className="relative overflow-hidden py-16 md:py-24">
        ...
        <div className="relative z-10 container">
          ...
          <p className="max-w-3xl text-xl text-white/80 md:text-2xl">
            Дезинфекция грузовых автомобилей, фургонов и рефрижераторов. Санитарная безопасность пищевых перевозок,
            устранение запахов, соответствие ХАССП.
          </p>
        </div>
      </section>
            ...
            <ProcessList
              steps={[
                ...
                },
                {
                  ...
                  description:
                    'Установить озонатор внутри кузова на максимальной высоте. Подключить к бортовой сети (12В/24В) или внешнему источнику.',
                },
                {
                  title: 'Герметизация',
