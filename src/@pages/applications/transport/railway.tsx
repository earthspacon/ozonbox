      ...
      <section className="relative overflow-hidden py-16 md:py-24">
        ...
        <div className="relative z-10 container">
          ...
          <p className="max-w-3xl text-xl text-white/80 md:text-2xl">
            Дезинфекция пассажирских купе, плацкартов и санузлов. Обработка в депо между рейсами, устранение запахов,
            борьба с плесенью в системах вентиляции.
          </p>
        </div>
      </section>
      ...
      <section className="cta">
        <div className="container">
          ...
          <p className="cta__text">
            Получите бесплатную консультацию и расчёт оборудования для обработки пассажирских и грузовых вагонов
          </p>
