    ...
    <Layout>
      ...
      <div className="bg-bg-light border-b border-border">
        <div className="container py-4">
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-text-light">/</span>
            <span className="text-text-primary font-medium">Очистка нефтесодержащих стоков</span>
          </nav>
        </div>
      </div>
      ...
      <section className="relative py-16 md:py-24 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt="Очистка нефтесодержащих стоков"
            fill
        ...
        <div className="container relative z-10">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
            Очистка нефтесодержащих сточных вод озонированием
          </h1>
          <p className="text-xl md:text-2xl text-white/80 max-w-3xl">
            Глубокая деструкция нефтепродуктов до CO₂ и H₂O. Достижение ПДК для сброса в водоёмы рыбохозяйственного назначения без реагентов и вторичных загрязнений.
          </p>
        </div>
      </section>
        ...
        <div className="container">
          <StatGrid columns={4}>
            ...
            <StatCard
              value="0,05"
              label="мг/л ПДК"
              description="Достижение норматива сброса"
              variant="accent"
            />
            <StatCard
              value="3-5"
              label="мг О₃/мг НП"
              description="Расход озона на деструкцию"
              variant="primary"
            />
            <StatCard
              value="0"
      ...
      <article className="py-12 md:py-16">
        <div className="container max-w-4xl">
          ...
          <ArticleSection>
            <Paragraph>
              Сточные воды промышленных предприятий, загрязнённые нефтепродуктами, представляют одну из наиболее серьёзных экологических проблем. Один литр нефти способен загрязнить до 1 миллиона литров воды, создавая плёнку, препятствующую газообмену и угрожающую гибелью водной экосистеме.
            </Paragraph>
            <Paragraph>
              Озонирование — передовой метод глубокой очистки нефтесодержащих сточных вод, обеспечивающий деструкцию углеводородов до углекислого газа и воды. В отличие от традиционных методов (флотация, сорбция, биоочистка), озонирование обеспечивает полную минерализацию загрязнителей без образования вторичных отходов.
            </Paragraph>
          </ArticleSection>

          <HighlightBox variant="warning">
            <strong>Нормативные требования:</strong> ПДК нефтепродуктов для сброса в водоёмы рыбохозяйственного назначения — 0,05 мг/л (ГОСТ 17.1.3.07-82). Для сброса в городскую канализацию — 4,0 мг/л. Превышение ПДК влечёт экологические платежи и штрафы до 2 млн рублей.
          </HighlightBox>

          <ArticleSection title="Механизм окисления нефтепродуктов озоном">
            <Paragraph>
              Озон — мощный окислитель с окислительно-восстановительным потенциалом 2,07 В (против 1,36 В у хлора). При взаимодействии с нефтепродуктами протекают реакции окислительной деструкции:
            </Paragraph>
            <BulletList items={[
            ...
            <HighlightBox variant="info">
              <strong>Окислительная деструкция vs. сорбция:</strong> В отличие от активированного угля, который только концентрирует загрязнители и требует регенерации или утилизации, озонирование разрушает молекулы нефтепродуктов, исключая образование вторичных отходов.
            </HighlightBox>
          </ArticleSection>

          <ArticleSection title="Технологическая схема очистки">
            <Paragraph>
              Промышленная установка озонирования нефтесодержащих стоков включает несколько ступеней обработки для достижения максимальной эффективности:
            </Paragraph>

            <ProcessList steps={[
              {
                title: 'Предварительная механическая очистка',
                description: 'Удаление взвешенных веществ, отстаивание в нефтеловушках. Снижение концентрации нефтепродуктов до 30-50 мг/л.',
              },
              {
                title: 'Флотация с озоновоздушной смесью',
                description: 'Подача озоновоздушной смеси (5-10 мг/л) через эжекторы. Флотация эмульгированных нефтепродуктов.',
              },
              {
                title: 'Контактная камера озонирования',
                description: 'Глубокое окисление растворённых нефтепродуктов. Доза озона 3-5 мг на 1 мг нефтепродуктов. Время контакта 20-30 минут.',
              },
              {
                title: 'Дегазация и доочистка',
                description: 'Удаление избыточного озона и продуктов окисления. При необходимости — фильтрация через активированный уголь.',
              },
              {
                title: 'Контроль качества',
                description: 'Автоматический мониторинг концентрации нефтепродуктов на выходе. Регулирование дозы озона по показаниям датчиков.',
              },
            ]} />

            <DataTable
              caption="Параметры озонирования для различных концентраций нефтепродуктов"
              headers={['Исходная концентрация НП, мг/л', 'Доза озона, мг/л', 'Время контакта, мин', 'Остаточная концентрация, мг/л']}
              rows={[
          ...
          <ArticleSection title="Типы нефтесодержащих стоков и особенности очистки">
            <Paragraph>
              Эффективность озонирования зависит от состава и концентрации нефтепродуктов в стоках:
            </Paragraph>
            ...
            <HighlightBox variant="success">
              <strong>Синергетический эффект:</strong> Комбинирование озонирования с УФ-облучением (процесс O₃/UV) повышает эффективность окисления на 30-40% за счёт образования гидроксильных радикалов (•OH) с окислительным потенциалом 2,80 В.
            </HighlightBox>
          </ArticleSection>
          ...
          <ArticleSection title="Экологические и экономические показатели">
            ...
            <HighlightBox variant="info">
              <strong>Расчёт экономии:</strong> При сбросе 100 м³/сут стоков с концентрацией НП 20 мг/л превышение ПДК составляет 400 раз. Плата за сброс — до 50 000 руб/месяц. Озонирование окупается за 8-12 месяцев только на экономии экологических платежей.
            </HighlightBox>
          </ArticleSection>

          <ArticleSection title="Соответствие нормативным требованиям">
            <Paragraph>
              Озонирование обеспечивает соответствие действующим нормативам:
            </Paragraph>
            <BulletList items={[
          ...
          <ArticleSection title="Кейс: НПЗ мощностью 6 млн тонн/год">
            <Paragraph>
              Внедрение озонирования на очистных сооружениях нефтеперерабатывающего завода:
            </Paragraph>
            <DataTable
      ...
      <section className="cta">
        <div className="container">
          <h2 className="cta__title">Проектирование системы очистки нефтесодержащих стоков</h2>
          <p className="cta__text">Получите технико-коммерческое предложение с расчётом оборудования для вашего предприятия</p>
