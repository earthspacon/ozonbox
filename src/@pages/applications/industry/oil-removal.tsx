      ...
      <section className="relative overflow-hidden py-16 md:py-24">
        ...
        <div className="relative z-10 container">
          ...
          <p className="max-w-3xl text-xl text-white/80 md:text-2xl">
            Глубокая деструкция нефтепродуктов до CO₂ и H₂O. Достижение ПДК для сброса в водоёмы рыбохозяйственного
            назначения без реагентов и вторичных загрязнений.
          </p>
        </div>
      </section>
      ...
      <section className="cta">
        <div className="container">
          ...
          <p className="cta__text">
            Получите технико-коммерческое предложение с расчётом оборудования для вашего предприятия
          </p>
