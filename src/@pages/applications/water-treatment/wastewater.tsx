  ...
  return (
    <Layout>
      ...
      <div className="bg-bg-light border-border border-b">
        <div className="container py-4">
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-text-light">/</span>
            <span className="text-text-primary font-medium">Сточные воды</span>
          </nav>
        </div>
      </div>
      ...
      <section className="cta">
        <div className="container">
          <h2 className="cta__title">Нужна система очистки стоков?</h2>
          <p className="cta__text">Получите бесплатный расчёт системы озонирования для вашего предприятия</p>
