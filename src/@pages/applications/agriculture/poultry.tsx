...
export function PoultryPage() {
  ...
  return (
    <Layout>
      <Seo title={t('subcategories.poultry.title', { ns })} description={t('subcategories.poultry.shortDesc', { ns })} />
      {/* Breadcrumbs */}
      <div className="bg-bg-light border-border border-b">
        <div className="container py-4">
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-text-light">/</span>
            <span className="text-text-primary font-medium">{t('subcategories.poultry.title', { ns })}</span>
          </nav>
        </div>
      </div>
      ...
      <section className="relative overflow-hidden py-16 md:py-24">
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt={t('subcategories.poultry.title', { ns })}
            fill
        ...
        <div className="relative z-10 container">
          ...
          <h1 className="mb-6 text-4xl font-bold text-white md:text-5xl lg:text-6xl">
            {t('subcategories.poultry.title', { ns })}
          </h1>
          <p className="max-w-3xl text-xl text-white/80 md:text-2xl">
            {t('subcategories.poultry.shortDesc', { ns })}
          </p>
        </div>
      </section>
