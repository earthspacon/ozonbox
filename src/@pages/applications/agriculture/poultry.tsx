    ...
    <Layout>
      ...
      <section className="relative py-16 md:py-24 overflow-hidden">
        ...
        <div className="container relative z-10">
          ...
          <p className="text-xl md:text-2xl text-white/80 max-w-3xl">
            Комплексная технология для инкубации яиц, дезинфекции помещений, обработки кормов и воды, продления сроков хранения мяса птицы
          </p>
        </div>
      </section>
      ...
      <article className="py-12 md:py-16">
        <div className="container max-w-4xl">
          ...
          <ArticleSection>
            <Paragraph>
              Озонирование — ключевая технология для современного промышленного птицеводства. Благодаря уникальным антибактериальным свойствам озона, его экологической чистоте, безопасности и простоте применения, технология находит применение на всех этапах производства: от инкубации яиц до хранения готовой продукции.
            </Paragraph>
            <Paragraph>
              Плохой микроклимат и бактериальная загрязнённость в помещениях снижают яйценоскость кур-несушек на 25%, среднесуточный привес — на 10%. Озонирование позволяет решить эти проблемы без использования химических препаратов, которые могут попадать в продукты питания.
            </Paragraph>
          </ArticleSection>

          <HighlightBox variant="info">
            <strong>Важно:</strong> Предельно допустимая концентрация озона для птицы составляет до 1,2 мг/м³ — это в 12 раз выше, чем для человека (0,1 мг/м³). Это позволяет проводить эффективную обработку в присутствии птицы при соблюдении режимов.
          </HighlightBox>
          ...
          <ArticleSection title="Инкубация яиц: повышение вывода молодняка">
            <Paragraph>
              Обработка инкубационных яиц озоном (~10 мг/м³) улучшает их качество и повышает вывод молодняка с последующей высокой жизнеспособностью. В замкнутом пространстве инкубатора возникает риск кислородного голодания эмбрионов. Озон, как производная кислорода, улучшает воздушную среду и, проникая сквозь скорлупу, питает эмбрионы кислородом.
            </Paragraph>
            ...
            <DataTable
              ...
              headers={['Вид птицы', 'Вывод без озона, %', 'Вывод с озоном, %', 'Сохранность без озона, %', 'Сохранность с озоном, %']}
              rows={[
            ...
            <HighlightBox variant="success">
              Рекомендации ВНИТИП: длительное хранение инкубационных яиц в среде с озоном предотвращает преждевременную порчу, снижает обсеменённость скорлупы в 2-7 раз, препятствует развитию плесени и продлевает срок хранения до 10 суток.
            </HighlightBox>
          </ArticleSection>

          <ArticleSection title="Дезинфекция воздуха на птицефермах">
            <Paragraph>
              В результате жизнедеятельности птицы воздух птичника загрязняется вредными веществами: аммиаком (до 0,3-0,5 мг/л при ПДК 0,01 мг/л), сероводородом, углекислым газом, органической пылью с микрофлорой (до 30-50 мг/л).
            </Paragraph>
            <Paragraph>
              Озонирование в системе рециркуляции позволяет очистить воздух без значительных затрат на вентиляцию и обогрев.
            </Paragraph>
            ...
            <HighlightBox variant="info">
              Периодическое озонирование (8-12 часов раз в 3-5 дней) снижает содержание вредных газов на 80-85% и обсеменённость бактериями и плесенью на 80-90%.
            </HighlightBox>
          </ArticleSection>

          <ArticleSection title="Обеззараживание кормов">
            <Paragraph>
              Микрофлора и плесневые грибки в кормах вырабатывают токсины, создающие угрозу здоровью птицы. Обработка кормов озоном значительно снижает наличие микрофлоры и токсинов, повышает биологическую ценность и усвояемость кормов.
            </Paragraph>

            <DataTable
              caption="Эффективность обеззараживания кормов озоном"
              headers={['Показатель', 'Пшеница без озона', 'Пшеница с озоном', 'Комбикорм без озона', 'Комбикорм с озоном']}
              rows={[
          ...
          <ArticleSection title="Продление сроков хранения мяса птицы">
            <Paragraph>
              Положительный эффект при хранении мяса достигается при ежедневном озонировании в течение 2 часов при концентрации озона ~6 мг/м³. Сохранность мяса птицы в охлаждённом виде (+4°С) увеличивается в 4 раза.
            </Paragraph>
            ...
            <ComparisonTable
              ...
              rows={[
                ...
                { parameter: 'Бактериальная загрязнённость после хранения', value1: '65 колоний/мл', value2: '736 колоний/мл' },
              ]}
            />

            <HighlightBox variant="success">
              За 20 дней хранения мясо с озонированием сохраняло первоначальную свежесть и нежность без запаха. Без обработки — зеленоватый цвет и гнилостный запах уже через 5 дней.
            </HighlightBox>
          </ArticleSection>
