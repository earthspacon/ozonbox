    ...
    <Layout>
      ...
      <section className="relative py-16 md:py-24 overflow-hidden">
        ...
        <div className="container relative z-10">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
            Озонирование в животноводстве
          </h1>
          <p className="text-xl md:text-2xl text-white/80 max-w-3xl">
            Дезинфекция помещений содержания животных, обработка питьевой воды и кормов. Снижение заболеваемости и повышение продуктивности без антибиотиков.
          </p>
        </div>
      </section>
        ...
        <div className="container">
          <StatGrid columns={4}>
            ...
            <StatCard
              value="0"
              label="Антибиотиков"
              description="Экологически чистая продукция"
              variant="accent"
            />
          </StatGrid>
        </div>
      ...
      <article className="py-12 md:py-16">
        <div className="container max-w-4xl">
          ...
          <ArticleSection>
            <Paragraph>
              Современное животноводство сталкивается с серьёзными вызовами: рост антибиотикорезистентности, ужесточение требований к экологичности продукции, необходимость повышения продуктивности при снижении затрат. Озонирование — технология, которая решает эти задачи комплексно.
            </Paragraph>
            <Paragraph>
              Применение озона в животноводстве позволяет снизить заболеваемость поголовья на 30-50%, повысить продуктивность на 10-15% и отказаться от профилактического применения антибиотиков. Это особенно актуально в контексте запрета ЕС на использование антибиотиков как стимуляторов роста.
            </Paragraph>
          </ArticleSection>

          <HighlightBox variant="info">
            <strong>ПДК озона для животных:</strong> до 1,0 мг/м³ для КРС и свиней, до 1,2 мг/м³ для птицы. Это позволяет проводить профилактические обработки в присутствии животных при соблюдении режимов.
          </HighlightBox>
          ...
          <ArticleSection title="Дезинфекция воздуха в помещениях">
            <Paragraph>
              Воздух в животноводческих помещениях загрязняется аммиаком, сероводородом, пылью и микроорганизмами. Концентрация аммиака может достигать 0,02-0,03 мг/л при ПДК 0,01 мг/л. Это снижает продуктивность, повышает заболеваемость и ухудшает условия труда персонала.
            </Paragraph>
            ...
            <HighlightBox variant="success">
              Регулярное озонирование (2-3 раза в сутки по 15-20 минут при концентрации 0,5-1,0 мг/м³) снижает респираторные заболевания КРС на 40-50% и повышает среднесуточный привес на 8-12%.
            </HighlightBox>
          </ArticleSection>

          <ArticleSection title="Обеззараживание питьевой воды">
            <Paragraph>
              Качество питьевой воды напрямую влияет на здоровье и продуктивность животных. Вода из открытых источников и даже артезианских скважин часто содержит патогенные микроорганизмы, железо, марганец и органические соединения.
            </Paragraph>
            <Paragraph>
              Озонирование воды обеспечивает:
            </Paragraph>
            <BulletList items={[
          ...
          <ArticleSection title="Обработка кормов">
            <Paragraph>
              Корма — основной источник микотоксинов и патогенных микроорганизмов, попадающих в организм животных. Озонирование кормов позволяет:
            </Paragraph>
            <BulletList items={[
            ...
            <HighlightBox variant="info">
              Рекомендуемый режим обработки кормов: концентрация озона 10-15 мг/м³, время обработки 60-120 минут в зависимости от влажности и загрязнённости корма.
            </HighlightBox>
          </ArticleSection>

          <ArticleSection title="Дезинфекция молочного оборудования">
            <Paragraph>
              На молочных фермах озон применяется для дезинфекции доильного оборудования, танков-охладителей, молокопроводов и ёмкостей. Это позволяет отказаться от химических моющих средств и обеспечить безопасность молочной продукции.
            </Paragraph>
