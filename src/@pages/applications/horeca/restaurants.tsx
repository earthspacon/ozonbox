  ...
  return (
    <Layout>
      ...
      <div className="bg-bg-light border-border border-b">
        <div className="container py-4">
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-text-light">/</span>
            <span className="text-text-primary font-medium">Рестораны и кафе</span>
          </nav>
        </div>
      </div>
      ...
      <section className="cta">
        <div className="container">
          <h2 className="cta__title">Создать атмосферу свежести в вашем заведении?</h2>
          <p className="cta__text">Получите бесплатную консультацию и расчёт оборудования для вашего ресторана</p>
